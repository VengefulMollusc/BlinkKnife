...
//SURFACE DX11
SubShader {
	Tags { "Queue"="Geometry+100" "IgnoreProjector"="True" "RenderType"="SuimonoWater" }
	...
	CGPROGRAM
		...
		#pragma surface SuimonoSurfFoam SuimonoLightFoam addshadow vertex:SuimonoVert tessellate:SuimonoTess alpha
	ENDCG
}
...
SubShader {
	...
	CGPROGRAM
		...
		#pragma surface SuimonoSurfFoam SuimonoLightFoam addshadow alpha vertex:SuimonoVert
	ENDCG
}
